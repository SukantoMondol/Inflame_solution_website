      ...
      <div className="pos-software">
        ...
        <section className="hero">
          <div className="container">
            ...
            >
              <h1 className="h1">
                Empower HR with <span>HRPro</span>
              </h1>
              <p className="p">
                Simplify employee management, automate payroll, and ensure compliance with tools designed to boost HR efficiency and accuracy.
              </p>
              ...
              {[
                {
                  icon: <FaCashRegister />,
                  title: "Payroll Automation",
                  desc: "Automate payroll calculations and tax filings with ease.",
                },
                {
                  icon: <FaChartLine />,
                  title: "HR Analytics",
                  desc: "Track employee performance and HR metrics with clear dashboards.",
                },
                {
                  icon: <FaUsers />,
                  title: "Employee Management",
                  desc: "Manage profiles, schedules, and benefits in one platform.",
                },
                {
                  icon: <FaMobileAlt />,
                  title: "Mobile Access",
                  desc: "Handle HR tasks on the go with our mobile app.",
                },
                {
                  icon: <FaGift />,
                  title: "Benefits Administration",
                  desc: "Streamline employee benefits enrollment and tracking.",
                },
                {
                  icon: <IoIosLock />,
                  title: "Secure Data",
                  desc: "Protect sensitive HR data with top-tier encryption.",
                },
                {
                  icon: <FaPlug />,
                  title: "Seamless Integrations",
                  desc: "Sync with accounting, time-tracking, and compliance tools.",
                },
                {
                  icon: <FaStar />,
                  title: "Compliance Tracking",
                  desc: "Ensure adherence to labor laws with automated reports.",
                },
              ].map((feature, index) => (
                <motion.div
                  key={index}
        ...
        <section className="benefits section-padding" id="benefits">
          <div className="container">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="h1">Why HRPro Excels</h2>
              <p className="p">
          ...
          <div className="container">
            ...
            >
              ...
              <div className="faq-item">
                <h5>Is HRPro compatible with mobile devices?</h5>
                <p>
                  Yes, HRPro offers full mobile compatibility, allowing you to manage HR and payroll tasks from anywhere using our mobile app.
                </p>
              </div>
              <div className="faq-item">
                <h5>Can I integrate HRPro with my existing systems?</h5>
                <p>
                  Absolutely. HRPro supports seamless integrations with accounting, time-tracking, and compliance platforms.
                </p>
              </div>
            </motion.div>
          </div>
